/**const socialLinks = [
  {
    href: 'https://github.com/kluckysingh',
  ...
  {
    href: 'https://www.linkedin.com/in/lucky-singh-920846242/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://leetcode.com/u/singhrimjim33/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.hackerrank.com/profile/singhrimjim33',
...
const socialLinks = [
  ...
  {
    href: 'https://leetcode.com/u/singhrimjim33/',
    // Optimized LeetCode Icon
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.173 5.798a1.372 1.372 0 0 0-.167 1.767l.115.158c-1.36.436-2.587 1.258-3.596 2.457l-.001.002-.002.002c-2.31 2.744-2.454 6.711-.314 9.614l.002.002.002.003c.094.127.194.249.298.366l5.352 5.395a1.372 1.372 0 0 0 1.93-.016l5.35-5.204a1.372 1.372 0 0 0 0-1.928 1.374 1.374 0 0 0-1.929 0l-4.375 4.256a.238.238 0 0 1-.336-.003l-4.48-4.516a6.22 6.22 0 0 1-1.092-7.394l-.003-.003.002.003c.87-1.398 2.302-2.398 3.93-2.613a1.37 1.37 0 0 0 1.055-1.168l.067-.525.688-.865a1.377 1.377 0 0 0-.203-1.905L14.444.438A1.372 1.372 0 0 0 13.483 0zm-2.348 7.373a1.37 1.37 0 0 0-1.127.59l-3.376 4.904a1.37 1.37 0 0 0 .285 1.83 1.374 1.374 0 0 0 1.83-.284l3.376-4.905a1.372 1.372 0 0 0-.988-2.135zm5.73 3.693a1.372 1.372 0 0 0-.853 2.456l3.056 2.193a1.373 1.373 0 0 0 1.834-.236 1.374 1.374 0 0 0 .236-1.834l-3.055-2.193a1.373 1.373 0 0 0-1.218-.386z" />
      </svg>
    ),
    alt: 'LeetCode'
  },
  {
    href: 'https://www.hackerrank.com/profile/singhrimjim33',
    // Optimized HackerRank Icon
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
         <path d="M12 0C5.373 0 0 5.373 0 12c0 6.628 5.373 12 12 12s12-5.372 12-12c0-6.627-5.373-12-12-12zm4.787 16.517h-2.07v-3.793h-1.636v3.793h-2.099V7.483h2.099v3.66h1.636v-3.66h2.07v9.034z"/>
      </svg>
    ),
    alt: 'HackerRank'
  },
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg-flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        I am currently open to internship and entry-level opportunities. Let's connect to discuss how I can contribute to your engineering team!
                    </p>
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            ...
                            href={href}
                            target="_blank"
                            className="w-12 h-112 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
                            >
                                {icon}
                ...
                <form 
                action="https://getform.io/f/aqoeddna" 
                method="post"
                ...
                >
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            autoComplete="email"
                            required
                            placeholder="singhluckyy4444@gmail.com"
                            className="text-field" />
                        </div>
